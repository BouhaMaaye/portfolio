...
J’y ai contribué à l’intégration des premières solutions IA du groupe, en développant des projets en Machine Learning, Deep Learning, analyse de données et automatisation.
              <motion.p 
                className="text-gray-300 text-lg"
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
