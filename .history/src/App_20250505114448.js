            ...
            >
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 mx-auto lg:mx-0">
                ...
                <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-white/10 shadow-[0_0_40px_rgba(59,130,246,0.3)]">
                  <img 
                    src="/your-profile-photo.jpg" // Remplacez par votre photo
                    alt="Bouha Maaye"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-blue-300">IA pour les Appels d'Offres</h3>
                <p className="text-gray-300">
                  Développement d'une IA analysant les documents d'appels d'offres pour générer des résumés automatiques et remplir dynamiquement un tableau Excel avec les données clés.
                </p>
                
                <div className="flex flex-wrap gap-2">
                  {["NLP", "Python", "Azure", "Excel Automation"].map((tech, i) => (
              ...
              <div className="relative aspect-video bg-gray-800/50 rounded-xl overflow-hidden border border-gray-700">
                {/* Remplacez par une image de votre projet */}
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-900/30 to-black">
                  <span className="text-xl text-gray-400">Capture d'écran du projet</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-cyan-300">Vision par Ordinateur pour la Sécurité</h3>
                <p className="text-gray-300">
                  Conception d'un système de détection des manquements aux règles de sécurité sur les chantiers via l'analyse d'images, contribuant à améliorer la prévention des accidents.
                </p>
                
                <div className="flex flex-wrap gap-2">
                  {["Computer Vision", "PyTorch", "Azure", "Sécurité"].map((tech, i) => (
              ...
              >
                ...
                <div className="relative h-full bg-gray-900/70 backdrop-blur-sm border border-gray-800 rounded-xl overflow-hidden hover:border-blue-400/30 transition-all duration-300 flex flex-col">
                  <div className="relative aspect-video overflow-hidden">
                    {/* Remplacez par l'image de votre projet */}
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-900/30 to-black">
