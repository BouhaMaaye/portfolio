        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              >
Diplômé d’un baccalauréat en mathématiques, j’ai poursuivi une licence en mathématiques et informatique avec un parcours en programmation, avant de me spécialiser en master Data Science et Intelligence Artificielle.

Mon goût prononcé pour l’innovation m’a conduit à effectuer un stage en tant que data analyste chez Monoprix, puis à intégrer SPIE CityNetwork pour deux années d’alternance, en partenariat avec Microsoft France.
J’ai eu la chance d’y faire partie des premiers collaborateurs impliqués dans l’intégration de technologies d’intelligence artificielle au sein du groupe.

Durant cette expérience, j’ai développé de solides compétences en Machine Learning, Deep Learning, data visualisation et automatisation avancée via Power Platform et Azure.
J’ai mené plusieurs projets concrets en NLP, vision par ordinateur, analyse d’appels d’offres, et automatisation de dashboards opérationnels, avec une approche orientée impact et valeur métier.

Aujourd’hui, je combine une expertise technique approfondie avec une expérience terrain, et je suis prêt à contribuer activement à des projets ambitieux mêlant IA, données et transformation digitale.              </motion.p>
